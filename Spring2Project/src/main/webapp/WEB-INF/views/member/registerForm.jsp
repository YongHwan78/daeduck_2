...
<body>
	...
	<p>
		...
		그리고, 매개변수의 위치는 순서에 상관없고 오직 매개변수명이 
		일치하면 요청 데이터를 취득할 수 있다.
	</p>
	...
	<p>
		1) URL 경로 상의 경로 변수가 여러 개일때 @PathVariable 어노테이션을 사용하여
		특정한 경로 변수명을 지정해준다.
	</p>
	...
	<p>
		2) 폼 텍스트 필드 요소값을 자바빈즈 매개변수와 기본 데이터 타입인 정수 타입 매개변수로
		처리한다.
	</p>
	...
	<p>
		...
		값이 날짜 문자열 형식으로 설정 시, Date 타입으로 받을수 있는가?
	</p>
	...
	<form action="/registerSelect" method="post">
		...
		<select name="nationality">
			...
			<option value="austrailoa">호주</option>
