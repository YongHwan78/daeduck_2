...
public class JSTLHomeController {
	 ...
	 * 		─────────────────────────────────────────────────────────────────
	 * 		[ 
	 * 			taglib 지시자 사용 : <%@ taglib uri="http://java.sun.com/jsp/jstl/core" 
	 * 									prefix="c" %>
	 * 		]
	 * 
	 * 		2) fmt태그 라이브러리
	 ...
	 * 		─────────────────────────────────────────────────────────────────
	 * 		[ 
	 * 			taglib 지시자 사용 : <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" 
	 * 									prefix="fmt" %>
	 * 		]
	 * 
	 * 		3) function 태그 라이브러리
	 ...
	 * 		<fn:indexOf>			| 지정한 문자열이 처음으로 나왔을 때의 인텍스를 구한다.
	 ...
	 * 		─────────────────────────────────────────────────────────────────
	 * 		[
	 * 			taglib 지시자 사용 : <%@ taglib uri="http://java.sun.com/jsp/jstl/functions"
	 * 									prefix="fn" %>
	 * 		]
	 * 
	 * 		6. 코어 태그
	 ...
	 * 		default		| Obejct	| value의 결과값이 null인 경우 출력할 값(대신 출력됨)
	 * 		─────────────────────────────────────────────────
	 * 
	 *  	2) <c:set>
	 *  	- JSP에서 사용할 변수를 설정한다.
	...
	// c:catch
	// EL에서 발생한 에러가 아니라, 자바식에서 발생한 에러 정보기 떄문에 var 속성에 담긴 에러 정보를 확인할
	// 수 있다.
