...
public class DatabaseConnectController {
	 ...
	 * 			등을 처리해준다.
	 * 			기존 SQL 쿼리를 이용하여 서비스를 처리할때에 필드가 추가되면 필드와 관련되어 있는 기능, sql, 추가된 필드 등을
	 ...
	 * 
	 * 			JPA는 JPA구현체인 hibernate를 이용해서 사용합니다. 그러기 위해선 관련 의존관계를 등록 후 사용해야합니다.
	 ...
	 * 			그만큼 설계라인의 정확성이 필요하고 여러 방면에서 정확한 검증이 재대로 끝나지 않으면 적용하기가 까다롭습니다.
	 * 
	 *  		[용어]
	 *  		*** ORM이란?
